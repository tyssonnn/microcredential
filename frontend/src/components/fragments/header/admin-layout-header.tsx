    ...
    <header className="w-full">
      <div className="w-full glass-card rounded-2xl p-4 px-5 flex justify-between items-center transition-all duration-300">
        ...
        <div className="flex items-center gap-4">
          ...
          <span className="bg-emerald-50 border border-emerald-100 text-emerald-700 font-display font-extrabold text-xs tracking-wider px-3.5 py-2 rounded-xl flex items-center gap-1.5 shadow-sm">
