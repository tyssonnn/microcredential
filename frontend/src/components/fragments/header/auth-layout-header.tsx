    ...
    <header className="w-full">
      <div className="w-full glass-card rounded-2xl p-4 px-5 flex justify-between items-center transition-all duration-300">
        ...
        <div className="flex items-center gap-2">
          <span className="bg-indigo-50/80 border border-indigo-100/50 text-indigo-700 font-display font-extrabold text-xs tracking-wider px-3.5 py-2 rounded-xl flex items-center gap-1.5 shadow-sm">
